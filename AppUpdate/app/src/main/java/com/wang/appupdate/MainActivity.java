...
import com.wang.appupdate.util.ApkUtils;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Log.d("MainActivity", ApkUtils.getSourceApkPath(this));
        new Thread(new Runnable() {
            ...
            public void run() {
                if (PatchUtil.diff(path + "/jiudeng1.apk", path + "/jiudeng2.apk", path + "/test.patch") == 0) {
                    ...
                    boolean success = SignUtils.checkMd5(path + "/jiudeng2.apk", SignUtils.getMd5ByFile(new File(path + "/jiudeng3.apk")));
